...
/**
 * @returns {String} get the base path (including the final '/') of the current script.
 */
...
if (!workerScriptPath)
  ...
  console.error('Woleet hashfile worker script will be loaded from: ', workerScriptPath);
